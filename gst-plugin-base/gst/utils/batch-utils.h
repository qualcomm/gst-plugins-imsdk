...
#define GST_BATCH_CHANNEL_INDEX_OFFSET   7
// Bit mask containing the sequential number in the unique ID.
#define GST_BATCH_SEQUENTIAL_NUMBER_MASK 0x7F
...
#define GST_BATCH_CHANNEL_GET_SEQ_NUM(id) (id & GST_BATCH_SEQUENTIAL_NUMBER_MASK)
