...
#include "ml-postprocess-yolo-nas.h"
...
void Module::ParseTripleblockFrame(const Tensors& tensors,
  ...
  float* bboxes = (float *) tensors[0].data;
  float* scores = (float *) tensors[1].data;
  float* classes = (float *) tensors[2].data;
