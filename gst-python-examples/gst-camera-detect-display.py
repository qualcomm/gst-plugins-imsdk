...
Initializes and links elements for capturing, performs inference
(object detection) using MODEL and LABELS files, and renders video
on display.
"""
...
def create_pipeline(pipeline):
    ...
    elements = {
        ...
        "cam_caps"  : create_element("capsfilter", "cam_caps"),
    ...
    # Set properties
    elements["cam_caps"].set_property(
...
def main():
    ...
    # Create the pipeline
    try:
        pipeline = Gst.Pipeline.new("cam-detect-display-pipeline")
        if not pipeline:
