# Contributing to gst-plugins-imsdk
...
1. [Fork](https://github.com/qualcomm/gst-plugins-imsdk/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/gst-plugins-imsdk.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/gst-plugins-imsdk/pulls) from your branch to `main`.
